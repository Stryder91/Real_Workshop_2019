...
<body>
    <div class="hero0 col-12 text-center p-md-5 d-flex flex-wrap justify-content-center">
        <div class="col-md-4 mb-5 pb-5">
            <img src="../images/logo.svg" alt="Logo" class="col-md-4 mt-3">
            <h1 class="font-weight-bold pt-5 mt-5">Une galerie d’art précolombien</h1>
            <p class="font-weight-bold">Répertoriant une collection de plus de 200 oeuvres</p>
        </div>
        <div class="col-12 mt-5 pt-5">
            <div class="col-4 m-auto">
                <a href="#hero0">
                    <img class="col-2 m-auto mt-5" src="../images/anchor.png" alt="anchor">
                </a>
            </div>
        </div>
    </div>
    <?php include '../site/headersite.php';?>
    ...
    <div class="col-md-1"></div>
        <div class="col-12 col-md-4 text-left mt-5">
            ...
            <div>
            <?php include '../model/galerie.es.php';?>
            </div>
    ...
    <article class="hero text-center pt-5">
        ...
        <div class="text-center col-md-5 m-auto py-md-4">
            <?php include '../model/ven.es.main.php';?>
        </div>
        <button class="btn decouvrir mt-3">Read more</button>
    </article>
    <?php include '../site/footersite.php';?>
